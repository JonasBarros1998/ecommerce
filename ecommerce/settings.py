...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', os.getenv('NAME_TABLE_DB')),
        'USER': os.environ.get('DB_USER', os.getenv('NAME_USER_DB')),
        'PASSWORD': os.environ.get('DB_PASS', os.getenv('PASSWORD_USER_DB')),
